...
const defaultContent: SiteContent = {
  ...
  founder_bio_2: 'À frente da Luana Azevedo Marketing, criou uma metodologia proprietária que já conduziu mais de 200 marcas — de pequenos negócios autorais a operações corporativas — para um patamar onde concorrer por preço deixa de ser necessário.',
  ...
  cta_email: 'contato@luanaazevedo.com.br',
  footer_logo_icon: '',
  footer_brand: 'Luana Azevedo',
